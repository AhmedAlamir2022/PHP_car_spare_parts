...
$sql="update tblusers set FullName=:name,ContactNo=:mobileno,cid=:National_ID,dob=:dob,Address=:adress,City=:city,Country=:country where EmailId=:email";
...
<title>Car Spare Parts | My Profile</title>
<!--Bootstrap -->
          ...
          <form  method="post">
           <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input class="form-control white_bg" name="National_ID" value="<?php echo htmlentities($result->cid);?>" id="National_ID" type="text" required>
            </div>
            <div class="form-group">
