...
$sql="update tblvehicles set VehiclesTitle=:vehicletitle,VehiclesBrand=:brand,VehiclesOverview=:vehicleoverview,Price=:price,ModelYear=:modelyear,quantity=:quantity where id=:id ";
...
<head>
	...
	<title>Car Spare Parts | Employee Edit Product Info</title>
