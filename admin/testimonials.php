...
<head>
	...
	<title>Car Spare Parts |Admin Manage testimonials   </title>
...
<?php } ?></td>
<td><a href="testimonials.php?del=<?php echo $result->id;?>" onclick="return confirm('Do you want to delete');"><i class="fa fa-close"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
