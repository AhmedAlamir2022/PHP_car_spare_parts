...
echo "<script type='text/javascript'> document.location = 'manage-branches.php'; </script>";
}
?>
...
<head>
	...
	<title>Car Spare Parts | Admin Create Branch</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Create Branch</h2>
