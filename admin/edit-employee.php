...
$sql="update employee set username=:username,email=:email,ContactNo=:ContactNo,cid=:cid,branch_id=:branch_id where id=:id ";
...
echo "<script type='text/javascript'> document.location = 'reg-employee.php'; </script>";
}
	?>
<!doctype html>
...
<head>
	...
	<title>Car Spare Parts | Admin Edit Employee Info</title>
									...
									<div class="panel-body">
										...
										<form method="post" class="form-horizontal" enctype="multipart/form-data">
											<div class="form-group">
												...
												<div class="col-sm-4">
												<input type="text" name="username" class="form-control" value="<?php echo htmlentities($result->username)?>" >
												</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
												<input type="text" name="ContactNo" class="form-control" value="<?php echo htmlentities($result->ContactNo)?>" >
												</div>
