...
<head>
	...
	<title>Car Spare Parts | Admin Dashboard</title>
							...
							<div class="col-md-12">
								<div class="row">
									<div class="col-md-3">
										...
										Dashboard		<div class="stat-panel text-center">
<?php 
...
?>												
													...
													<div class="stat-panel-title text-uppercase">Listed Branches</div>
												</div>
											</div>
											<a href="manage-branches.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
								</div>
							</div>
...
?>
											...
											<a href="reg-employee.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
								</div>
							</div>
